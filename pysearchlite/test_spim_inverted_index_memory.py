...
from .spim_inverted_index_memory import (
    SinglePassInMemoryInvertedIndexMemory,
    read_token,
    write_token,
    write_doc_ids
)
...
@pytest.fixture
def spim_index(idx_dir) -> SinglePassInMemoryInvertedIndexMemory:
    yield SinglePassInMemoryInvertedIndexMemory(idx_dir)
